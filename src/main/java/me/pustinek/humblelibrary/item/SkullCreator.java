...
import me.pustinek.humblelibrary.utils.VersionUtilOld;
import me.pustinek.humblelibrary.utils.VersionUtils;
    ...
    public static void mutateItemMeta(SkullMeta meta, String b64) {
        try {
            if (VersionUtilOld.getServerBukkitVersion().isHigherThanOrEqualTo(VersionUtilOld.v1_19_1_R01)) {
                ...
                // Set the base64 texture in the PlayerTextures
//                URL url = new URL("https://textures.minecraft.net/texture/" + uuid);
//


                String base64decode = new String(Base64.getDecoder().decode(b64));
                ...
                textures.setSkin(skinUrl);  // Example URL construction

                // Set the modified textures back to the PlayerProfile
                playerProfile.setTextures(textures);

                // Apply the profile to the meta
                meta.setOwnerProfile(playerProfile);
            } else {

                System.out.println("Lower version that 1.19.1 !!!");
                // Use GameProfile in older versions
            ...
            // Fallback for very old versions without setProfile method
            try {
